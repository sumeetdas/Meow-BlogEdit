...
angular
    ...
    .controller('BlogEditCtrl', ['$scope', '$blogEdit', '$location', 'meta', '$timeout', '$route', '$window',
        function ($scope, $blogEdit, $location, meta, $timeout, $route, $window) {
            ...
            function getEditPostTemplateUrl () {
                if ($window.innerWidth >= 1340) {
                    return 'blog-edit.post.tpl.html';
                }
                else {
                    return 'blog-edit.post.mobile.tpl.html';
                }
            }
            ...
            $scope.blogEditSettings = {
                closeEl: '.close',
                overlay: {
                    templateUrl: getEditPostTemplateUrl()
                }
            };
            ...
            $scope.toggleMobileEditMode = function () {
                $scope.mobile.editMode = !$scope.mobile.editMode;
            }
    }]);